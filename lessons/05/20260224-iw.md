...
L'_**HyperText Transfer Protocol**_ (HTTP) è un protocollo di comunicazione utilizzato per il trasferimento di dati tra un client e un server su una rete.

HTTP standardizza come client e server comunicano tramite il metodo richiesta-risposta.
...
**Testa**: una riga di richiesta contenente:
*  il **metodo** (_method_);
* il percorso (_path_);
* la versione del protocollo utilizzato;
* le **intestazioni** (_headers_) contenenti informazioni per la comunicazione.
...
**Testa**: una riga di risposta contenente 
* la versione del protocollo usato;
* il **codice di stato** (_status code_);
* il **messaggio di stato**;
* le **intestazioni** contenenti varie informazioni per la comunicazione.
...
Le pagine Web sono costruite sulla base dei _**Web standards**_.
...
I _**Web standard**_ sono le tecnologie utilizzate per costruire siti Web.

Sono definiti da istituzioni come **W3C**, **WHATWG**, **ECMA**, **Khronos**.

Devono seguire questi principi:
* essere **aperti** (liberamente estendibili e utilizzabili);
* essere **accessibili** a quante più persone possibili e **interoperabili** con quante più tecnologie possibili;
* non rompere il Web esistente.
...
**JavaScript** è _un linguaggio di programmazione nato per aggiungere interattività alle pagine Web_. Permette l'esecuzione di determinate azioni in seguito allo scatenarsi di specifici eventi. Ora viene usato anche per altri ambienti non basati su browser.
...
![bg "https://developer.mozilla.org/en-US/docs/Learn_web_development/Getting_started/Web_standards/How_the_web_works"](img/0534.png)
...
![bg right "https://developer.mozilla.org/en-US/docs/Learn_web_development/Getting_started/Web_standards/How_the_web_works"](img/0534.png)
...
Immaginiamoci il Web come una strada. Da una parte, c'è casa nostra: il client. Dall'altra, c'è un negozio: il server.

La strada tra la casa e il negozio è la connessione Internet. Il TCP/IP è il mezzo che usiamo per attraversare la strada. Il DNS è l'indirizzo del negozio. HTTP è la lingua che utilizziamo per chiedere i prodotti. I dati sono i prodotti.

Digitare un URL o cliccare su un link equivale a camminare dalla casa al negozio, prendere i prodotti, e tornare.

---

![bg contain ""](img/0535.png)

<!-- footer: "" -->

---

![bg contain ""](img/0536.png)

---

![bg contain ""](img/0537.png)

---

![bg contain ""](img/0538.png)

---

![bg contain ""](img/0539.png)

---

![bg contain ""](img/0540.png)

---

![bg contain ""](img/0541.png)
